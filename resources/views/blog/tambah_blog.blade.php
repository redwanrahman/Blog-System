    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title font-weight-bold">ADD NEW BLOG
            ...
            <div class="card-body">
                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="image" class="font-weight-bold">INSERT BLOG IMAGE</label>
                    ...
                    <div class="form-group">
                        <label for="title" class="font-weight-bold">ENTER BLOG TITLE</label>
                    ...
                    <div class="form-group">
                        <label for="content" class="font-weight-bold">ENTER BLOG CONTENT</label>
                        <textarea id="content" class="form-control" name="konten" rows="5"
                            placeholder="Enter Blog Content">{{ old('konten') }}</textarea>
